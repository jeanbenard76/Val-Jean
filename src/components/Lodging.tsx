...
const LODGING_CAROUSEL: LodgingCard[] = [
  ...
  },
  {
    ...
    description: "Gîte tout confort situé au cœur d'Oherville. L'alliance parfaite entre le charme normand et le confort moderne.",
    price: "Voir tarifs sur Booking",
  ...
  {
    id: 'vieux-puits',
    name: "Le Gîte du Vieux Puits",
    category: "GÎTES DE FRANCE",
    distance: "À OHERVILLE (SUR PLACE)",
    image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=600&q=80",
    description: "Une authentique demeure normande idéale pour se ressourcer en pleine nature, tout près du lieu de réception.",
    price: "Voir tarifs sur Gites.fr",
    highlights: ["Charme authentique", "Très calme", "Proche du Manoir"],
  ...
  {
    id: 'source',
    name: "Le Gîte de la Source",
    category: "GÎTES DE FRANCE",
    distance: "À OHERVILLE (SUR PLACE)",
    image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=600&q=80",
    description: "Hébergement chaleureux et accueillant, idéal pour se reposer après une longue journée de célébration.",
    price: "Voir tarifs sur Gites.fr",
    highlights: ["Confortable", "Cadre apaisant", "Proche de la fête"],
